							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" data-thumb="<?php echo $row['picture'] ?>">
									<div class="wrap-pic-w pos-relative" style="height: 600px;">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php $row['picture'] ?>">
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									onclick="location.href='carthandler.php?cart_id=<?php echo $row['id'] ?> &cart_name=<?php echo $row['name'] ?>
									&cart_price=<?php echo $row['price'] ?> '">
										Add to cart
									</button>
								</div>
							</div>	
